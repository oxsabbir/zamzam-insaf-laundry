...
const steps = [
  {
    ...
    description:
      "Send a quick WhatsApp message with your location. We'll confirm your pickup window (usually around 15 minutes).",
    time: "30 seconds",
  },
  {
    number: "2",
    ...
    description:
      "Our skilled team gathers your clothes and processes each batch with professional, careful treatment.",
    time: "15 min pickup",
  },
  {
    number: "3",
    icon: Sparkles,
    image: delivery,
    title: "Back Fresh & Clean",
    description:
      "Your garments return pressed, fresh, and ready to wear. Simply pay on delivery.",
    time: "Same day back",
  },
];
    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          ...
          >
            How Makkah Laundry HS Works
          </h2>
          <p className="text-base sm:text-xl font-medium mb-1 text-muted-foreground max-w-3xl mx-auto">
            Laundry that fits around your day.
            <br />
            <span className="text-primary  mt-2">
              Fresh, tidy garments at your doorstep.
            </span>
          </p>
        </div>
