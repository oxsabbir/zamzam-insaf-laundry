...
export default function PickupManager() {
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-100/40 rounded-full blur-3xl -z-10 translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-primary-100/40 rounded-full blur-3xl -z-10 -translate-x-1/2 translate-y-1/2" />
              ...
              <div className="lg:col-span-7 p-8 sm:p-10 flex flex-col justify-center">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-primary-600 text-white text-lg font-bold py-4 px-6 rounded-xl shadow-lg shadow-primary-600/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
                  >
                    <WhatsAppIcon
                      size={24}
